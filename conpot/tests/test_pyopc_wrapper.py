...
from conpot.protocols.opc.build_pyopc_mib_wrapper import mib2pyopc, find_mibs, compile_mib
from conpot.protocols.opc import command_responder
...
class TestBase(unittest.TestCase):
    def test_wrapper_processing(self):
        ...
        """
        result = mib2pyopc('conpot/tests/data/VOGON-POEM-MIB.mib')
        self.assertTrue('mibBuilder.exportSymbols("VOGON-POEM-MIB"' in result,
                        'mib2pyopc did not generate the expected output. Output: {0}'.format(result))
    ...
    def test_wrapper_output(self):
        ...
        try:
            ...
            cmd_responder.opcEngine.msgAndPduDsp.mibInstrumController.mibBuilder.loadModules('VOGON-POEM-MIB')
